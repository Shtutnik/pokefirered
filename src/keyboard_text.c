...
const u8 gText_NamingScreenKeyboard_Row1[] = _("{CLEAR 11}א{CLEAR 6}ב{CLEAR 6}ג{CLEAR 26}ד{CLEAR 6}ה{CLEAR 6}ו{CLEAR 6} {CLEAR 26}.");
const u8 gText_NamingScreenKeyboard_Row2[] = _("{CLEAR 11}ז{CLEAR 6}ח{CLEAR 6}ט{CLEAR 26}י{CLEAR 6}כ{CLEAR 6}ל{CLEAR 6} {CLEAR 26},");
const u8 gText_NamingScreenKeyboard_Row3[] = _("{CLEAR 11}מ{CLEAR 6}נ{CLEAR 6}ס{CLEAR 26}ע{CLEAR 6}פ{CLEAR 6}ק{CLEAR 6}ר{CLEAR 26} ");
const u8 gText_NamingScreenKeyboard_Row4[] = _("{CLEAR 11}ש{CLEAR 6}ת{CLEAR 6}ן{CLEAR 26}ם{CLEAR 6}ך{CLEAR 6}ף{CLEAR 6} {CLEAR 26} ");        
