...
ALIGNED(4) const u8 gText_UPDOWNPick_ABUTTONNext_BBUTTONBack[] = _("{DPAD_UPDOWN} בחר {A_BUTTON} הבא {B_BUTTON} בטל");
ALIGNED(4) const u8 gText_UPDOWNPick_ABUTTONBBUTTONCancel[] = _("{DPAD_UPDOWN} בחר {A_BUTTON}{B_BUTTON} בטל");
...
const u8 gSaveStatName_Badges[] = _("מדליות");
const u8 gSaveStatName_Pokedex[] = _("POKéDEX");
const u8 gSaveStatName_Time[] = _("זמן");
const u8 gUnknown_8416195[] = _("どこへ とびますか?");
const u8 gOtherText_Use[] = _("להשתמש");
const u8 gOtherText_Toss[] = _("זרוק");
const u8 gOtherText_Register[] = _("לבחור");
const u8 gOtherText_Give[] = _("לתת");
const u8 gUnknown_84161B7[] = _("けってい");
const u8 gOtherText_Walk[] = _("ללכת");
...
const u8 gText_Mail[] = _("הודעה");
const u8 gText_Take[] = _("לקחת");
const u8 gText_Store[] = _("לאחסן");
const u8 gOtherText_Check[] = _("לבדוק");
const u8 gText_PokeSum_Item_None[] = _("NONE");
const u8 gOtherText_Open[] = _("לפתוח");
const u8 gOtherText_Deselect[] = _("ביטול בחירה");
...
const u8 gUnknown_841623D[] = _("כן\nלא");
const u8 gText_GoBackToThePreviousMenu[] = _("בחזרה לתפריט הקודם.");
const u8 gText_WhatWouldYouLikeToDo[] = _("מה תרצו לעשות?");
...
const u8 gText_CancelParticipation[] = _("לבטל את השתתפותו?");
const u8 gUnknown_84176CE[] = _("");
const u8 gUnknown_84176CF[] = _("לבטל את הקרב?");
const u8 gText_TurnOff[] = _("כיבוי");
const u8 gUnknown_84176EB[] = _("מראה חיצוני");
const u8 gText_ItemStorage[] = _("אחסון פריטים");
const u8 gText_Mailbox[] = _("תיבת דואר");
const u8 gText_DepositItem2[] = _("הפקדת פריט");
const u8 gText_WithdrawItem2[] = _("משיכת פריט");
const u8 gUnknown_8417721[] = _("לזרוק את הפריט");
const u8 gText_StoreItemsInThePC[] = _("לשמור פריטים במחשב.");
const u8 gText_TakeOutItemsFromThePC[] = _("להוציא פריטים מהמחשב.");
const u8 gUnknown_841775D[] = _("זריקת הפריטים המופקדים מהמחשב");
const u8 gText_ThereAreNoItems[] = _("אין פריטים.{PAUSE_UNTIL_PRESS}");
const u8 gText_NoMoreRoomInBag[] = _("אין יותר\nמקום בתיק.");
const u8 gText_WithdrawHowMany[] = _("כמה {STR_VAR_1}\nלהוציא?");
const u8 gText_WithdrewQuantItem[] = _("הוצאו {STR_VAR_1}\n{STR_VAR_2}.");
const u8 gOtherText_Read[] = _("לקרוא");
const u8 gOtherText_MoveToBag[] = _("לשים בתיק");
const u8 gOtherText_Give2[] = _("לתת");
const u8 gText_TheresNoMailHere[] = _("אין כאן הודעות.{PAUSE_UNTIL_PRESS}");
const u8 gText_WhatWouldYouLikeToDoWithPlayersMail[] = _("מה תרצו לעשות עם ההודעה של {STR_VAR_1}?");
...
const u8 gText_WithdrawItem[] = _("פריט\nהוצא");
const u8 gText_Withdraw[] = _("להוציא");
...
const u8 gText_YourName[] = _("מהו שמך?");
const u8 gText_BoxName[] = _("BOX NAME?");
const u8 gText_PkmnsNickname[] = _("'s nickname?");
const u8 gText_RivalsName[] = _("שם היריב שלך?");
const u8 gText_MoveOkBack[] = _("{DPAD_ANY} לזוז {A_BUTTON} אישור {B_BUTTON} אחורה");
