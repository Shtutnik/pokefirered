...
extern const u8 gText_NamingScreenKeyboard_MNOPQRS[];
extern const u8 gText_NamingScreenKeyboard_TUVWXYZ[];
extern const u8 gText_NamingScreenKeyboard_Row1[];
extern const u8 gText_NamingScreenKeyboard_Row2[];
extern const u8 gText_NamingScreenKeyboard_Row3[];
extern const u8 gText_NamingScreenKeyboard_Row4[];
